...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // `border`, not `ring-1 ring-foreground/10`. Cards sat next to sidebars,
        // topbars, sheet headers and table heads that all use `border-border` —
        // two different edge treatments touching on every page, one of them a
        // ring that ignores --border entirely and so ignored the rebrand.
