  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // The `line` variant is the app's default for view switching, so its
        // active state carries the brand: teal underline, teal label. Matches
        // NavTabs, which uses `border-primary` for the same purpose.
